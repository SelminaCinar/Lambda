 ...
 Class'lara kısaltma isim olarak Pojo(Plain Old Java Object) Class denir
    ...
    */
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.println(ogrcSayisi1050denAzKckNotOrt(unv));
    ...
    public static OptionalInt ogrcSayisi1050denAzKckNotOrt(List<Universite> unv){
        return
                unv.stream().filter(t->t.getOgrSayisi()<1050).mapToInt(t->t.getNotOrt()).min();
    }
